...
namespace AHM_TOTAL_TRAVEL_WEB.Services
{
    public class ActivitiesServices
    {
        ...
        //public async Task<ServiceResult> RestaurantCreate(ActivitiesListViewModel restaurant, string token)
        //{
        //    var Result = new ServiceResult();

        //    try
        //    {
        //        var response = await _api.PostFormData<ActivitiesListViewModel, RequestStatus>(req => {
