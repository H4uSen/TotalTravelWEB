...
var CitiesList = ajaxRequest("https://totaltravel.somee.com/API/Cities/List");
fillCities(Pais_ID);
...
function crear() {
    ...
    if (ValidateFormStatus) {
        ...
        var CitiesInsertStatus = ajaxRequest("https://totaltravel.somee.com/API/Cities/Insert", city, "POST");

        if (CitiesInsertStatus.code == 200) {
            iziToastAlert(
                "!Registro creado con exito!", "", "success"
            );
            CitiesList = ajaxRequest("https://totaltravel.somee.com/API/Cities/List");
            fillCities(Pais_ID);
            getDefault();
        }
    }
...
function actualizar(id_ciudad) {
    ...
    if (ValidateFormStatus) {
        ...
        var CitiesInsertStatus = ajaxRequest("https://totaltravel.somee.com/API/Cities/Update?id=" + id_ciudad, city, "PUT");
...
function eliminar(id) {
    const capsula1 = () => {
        var response = ajaxRequest(`https://totaltravel.somee.com/API/Cities/Delete?id=${id}&mod=${Client_User_ID}`, null, "Delete");
