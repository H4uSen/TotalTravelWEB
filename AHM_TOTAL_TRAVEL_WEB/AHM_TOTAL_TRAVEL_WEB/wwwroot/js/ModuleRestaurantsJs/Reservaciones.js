...
var ReservacionRestaurant = ajaxRequest(urlAPI+"/API/ReservationRestaurant/List");
        ...
        if (Rflitro.length == 0) {
            ...
            for (var i = 0; i < Rflitro.length; i++) {
                ...
                <div class="ui card" style="width:100%" data-estado="${Estado ? 1 : 0}">
                    ...
                    <a class="btn-edit ui positive button w-100 reservT_trigger_button" id="Resv" href="javascript: ViewReservation(${item.iD_Restaurante},${item.id})">
