...
function ViewReservation(hoteid,transid) {
    var response = ajaxRequest("https://totaltravelapi.azurewebsites.net/API/Hotels/Find?id="+hoteid);
        ...
        if (response2.code == 200) {
            ...
            if (transporte.code == 200) {
                ...
                var response4 = ajaxRequest("https://totaltravelapi.azurewebsites.net/API/Partners/Find?id=" + t.partner_ID);
    ...
    var ReservacionView = ajaxRequest("https://totaltravelapi.azurewebsites.net/API/Reservation/Find?id=" + transid);
        ...
        if (ReservacionView.code == 200) {
            ...
            if (ReservacionDetView.code == 200) {
                ...
                for (var i=0; i < rooms.length; i++){
                    const item = rooms[i];
                    var RoomFind = ajaxRequest("https://totaltravelapi.azurewebsites.net/API/Rooms/Find?id=" + item.habitacionID);
                    try {
                        ...
                        divroom =
                            `<div class="item">
                                <div class="image">
                                    <img
                                        src="https://totaltravelapi.azurewebsites.net/Images/Default/DefaultPhoto.jpg">
                                </div>
                                <div class="content">
