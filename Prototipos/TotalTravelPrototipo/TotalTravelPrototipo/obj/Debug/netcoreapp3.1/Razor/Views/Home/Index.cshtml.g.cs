#pragma checksum "C:\Users\Angel Macea\source\repos\TotalTravelPrototipo\TotalTravelPrototipo\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d394d252f4f1a93d7e6d454d823f0a7ff31d2980"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d394d252f4f1a93d7e6d454d823f0a7ff31d2980", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "C:\Users\Angel Macea\source\repos\TotalTravelPrototipo\TotalTravelPrototipo\Views\Home\Index.cshtml"
                ...
                <div class=""row gx-5 bg-white"">
                    ...
                    <div class=""col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200"">
                        <div class=""d-flex align-items-center"">
                            ...
                            <div class=""mx-3"">
                                <h6 class=""h4 fw-light text-gray-600 mb-3"">New<br>Cli");
            WriteLiteral(@"ents</h6>
                    ...
                    <div class=""col-xl-3 col-sm-6 py-4"">
                        <div class=""d-flex align-items-center"">
                            <div class=""icon flex-shrink-0 bg-orange"">
                                <svg class=""svg-icon svg-icon-sm svg-icon-heavy"">
      ");
            WriteLiteral(@"                              <use xlink:href=""#list-details-1""> </use>
                                </svg>
                            </div>
                            <div class=""mx-3"">
    ...
    <div class=""container-fluid"">
        <div class=""row align-items-stretch"">
                ...
                <div class=""card mb-3"">
                    <div class=""card-body"">
                        <div class=""d-flex align-items-center"">
                            ...
                            <div class=""ms-3""><strong class=""text-lg d-block lh-1 mb-1"">152</strong><small class=""text-uppercase text-gray-500 small d-block lh-1"">Interview");
            WriteLiteral(@"s</small></div>
                        </div>
                    </div>
                </div>
                <div class=""card mb-0"">
            ...
            WriteLiteral(@"!-- Bar Chart   -->
                <div class=""card"">
                    <div class=""card-body"">
                        <strong class=""h2 mb-0 d-block text-violet"">95%</strong><small class=""text-gray-500 small text-uppercase d-block mb-3"">Current Server Uptime</small>
                ...
                <div class=""row align-items-center gx-lg-5 gy-3"">
                    <div class=""col-lg-6 border-lg-end"">
                        <div class=""d-flex align-items-center justify-content-between"">
                            <div class=""d-flex align-items-center"">
                                <img class=""img-fluid shadow-sm"" src=""assets/img/project-1.jpg"" alt=""..."" width=""50"">
                                <div class=""ms-3"">
  ...
  ");
        ...
        <div class=""card mb-3"">
            <div class=""card-body p-3"">
                <div class=""row align-items-center gx-lg-5 gy-3"">
                    <div class=""col-lg-6");
            WriteLiteral(@" border-lg-end"">
                        <div class=""d-flex align-items-center justify-content-between"">
                            <div class=""d-flex align-items-center"">
                                <img class=""img-fluid shadow-sm"" src=""assets/img/project-2.jpg"" alt=""..."" width=""50"">
                                <div class=""ms-3"">
                                    <h3 class=""h4 text-gray-700 mb-0"">Project Title</h3><small class=""text-gray-500"">Lorem Ipsum Dolor</small>
                                </div>
                            </div><span class=""text-sm text-gray-600 d-none d-sm-block"">Today at 4:24 AM</span>
                    ...
                    <div class=""col-lg-6"">
                        <div class=""d-flex align-items-center"">
                            <p class=""d-flex mb-0 text-gray-600 text-sm d-flex align-items-center flex-shrink-0""><i class=""far fa-clock me-1""></i>12:00 PM</p>
                            <p class=""d-flex mb-0 m");
            WriteLiteral(@"x-3 text-gray-600 text-sm d-flex align-items-center flex-shrink-0""><i class=""far fa-comment me-1""></i>20</p>
                            <div class=""progress w-100"" style=""height: 5px; max-width: 15rem"">
        ...
        <div class=""card mb-3"">
            <div class=""card-body p-3"">
                <div class=""row align-items-center gx-lg-5 gy-3"">
                    <div class=""col-lg-6 border-lg-end"">
                        <div class=""d-flex align-items-center justify-content-between"">
                            <div class=""d-flex align-items-center"">
                                <img class=""img-fluid shadow-sm"" src=""assets/img/project-3.jpg"" ");
            WriteLiteral(@"alt=""..."" width=""50"">
                                <div class=""ms-3"">
                                    <h3 class=""h4 text-gray-700 mb-0"">Project Title</h3><small class=""text-gray-500"">Lorem Ipsum Dolor</small>
                                </div>
                            </div><span class=""text-sm text-gray-600 d-none d-sm-block"">Today at 4:24 AM</span>
            ...
            WriteLiteral(@""" role=""progressbar"" style=""width: 45%; height: 6px;"" aria-valuenow=""25"" aria-valuemin=""0"" aria-valuemax=""100""></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class=""card-body p-3"">
                <div class=""row align-items-center gx-lg-5 gy-3"">
                    <div class=""col-lg-6 border-lg-end"">
                        <div class=""d-flex align-items-center justify-content-between"">
                            <div class=""d-flex align-items-center"">
                                <img class=""img-fluid shadow-sm"" src=""assets/img/project-4.jpg"" alt=""..."" width=""50"">
                                <div class=""ms-3"">
                                    <h3 class=""h4 text-gray-700 mb-0"">Project Title</h3><small class=""text-gray-500"">Lorem Ipsum Dolor</small>
                                </div>
            ");
            WriteLiteral(@"                </div><span class=""text-sm text-gray-600 d-none d-sm-block"">Today at 4:24 AM</span>
                        </div>
                    </div>
                    <div class=""col-lg-6"">
                        <div class=""d-flex align-items-center"">
            ...
            <div class=""col-lg-4"">
                <div class=""card mb-0"">
                    ...
                    <div class=""card-body d-flex flex-column"">
                        <h3 class=""mb-1"">Work Hours</h3><small class");
            WriteLiteral(@"=""text-gray-500 d-block mb-0"">Lorem ipsum dolor sit amet.</small>
            ...
            <div class=""col-lg-4"">
                <div class=""card mb-0"">
                    <div class=""card-close"">
                        <div class=""dropdown"">
                            <button class=""dropdown-toggle text-sm"" type=""button"" id=""closeCard1"" data-bs-toggle=""dropdown"" aria-expanded=""false""><i class=""fas fa-ellipsis-v""></i></button>
                            <div class=""dropdown-menu dropdown-menu-end shadow-sm"" aria-labelledby=""closeCard1""><a class=""dropdown-item py-1 px-3 remove"" ");
            WriteLiteral(@"href=""#""> <i class=""fas fa-times""></i>Close</a><a class=""dropdown-item py-1 px-3 edit"" href=""#""> <i class=""fas fa-cog""></i>Edit</a></div>
                        </div>
                    </div>
                    <div class=""card-body text-center"">
                        <div class=""client-avatar mb-3"">
                            <img class=""img-fluid rounded-circle shadow-0"" src=""assets/img/avatar-2.jpg"" alt=""..."">
            ...
            WriteLiteral(@"                      </div>
                    ...
                    <div class=""card-body p-0"">
                        <div class=""p-3 d-flex align-items-center"">
                            <img class=""img-fluid rounded-circle p-1 border border-faintGreen flex-shrink-0"" src=""assets/img/avatar-1.jpg"" alt=""..."" width=""50"">
                            <div class=""ms-3"">
                                <a class=""d-block"" href=""#"">
                                    <h3 class=""h5 fw-normal text-dark mb-0"">Lorem Ipsum Dolor</h3>
                                </a><small class=""text-gray-500"">Posted on 5th June 2017 by Aria Smith.   </small>
                            </div>
                        </div>
                        <div class=""p-3 d-flex align-items-center bg-light"">
           ");
            WriteLiteral(@"                 <img class=""img-fluid rounded-circle p-1 border border-faintGreen flex-shrink-0"" src=""assets/img/avatar-2.jpg"" alt=""..."" width=""50"">
                            <div class=""ms-3"">
                                <a class=""d-block"" href=""#"">
                                    <h3 class=""h5 fw-normal text-dark mb-0"">Lorem Ipsum Dolor</h3>
                        ...
                        <div class=""p-3 d-flex align-items-center"">
                            <img class=""img-fluid rounded-circle p-1 border border-faintGreen flex-shrink-0"" src=""assets/img/avatar-3.jpg"" alt=""..."" width=""50"">
                            <div class=""ms-3"">
                                <a class=""d-block"" href=""#"">
                                    <h3 class=""h5 fw-normal text-dark mb-0"">Lorem Ipsum Dolor</h3>
                                </");
            WriteLiteral(@"a><small class=""text-gray-500"">Posted on 5th June 2017 by Ashley Wood.   </small>
                            </div>
                        </div>
                        <div class=""p-3 d-flex align-items-center bg-light"">
                            <img class=""img-fluid rounded-circle p-1 border border-faintGreen flex-shrink-0"" src=""assets/img/avatar-4.jpg"" alt=""..."" width=""50"">
                            <div class=""ms-3"">
                                <a class=""d-block"" href=""#"">
                                    <h3 class=""h5 fw-normal text-dark mb-0"">Lorem Ipsum Dolor</h3>
                        ...
                        <div class=""p-3 d-flex align-items-center"">
                            <img class=""img-fluid rounded-circle p-1 border border-faintGreen flex-shrink-0"" src=""assets/img/avatar-5.jpg"" alt=""..."" width=""50"">
         ");
            ...
            WriteLiteral(@"dow-sm"" aria-labelledby=""closeCard1""><a class=""dropdown-item py-1 px-3 remove"" href=""#""> <i class=""fas fa-times""></i>Close</a><a class=""dropdown-item py-1 px-3 edit"" href=""#""> <i class=""fas fa-cog""></i>Edit</a></div>
                    ...
                    <div class=""card-body p-0"">
                        ...
                        <div class=""p-3 bg-light"">
                            <div class=""form-check mb-0 py-1"">
                       ");
            WriteLiteral(@"         <input class=""form-check-input"" type=""checkbox"" name=""input-2"" id=""input-2"" checked>
                ...
                ");
            WriteLiteral(@"                <label class=""form-check-label text-gray-600 text-sm"" for=""input-4"">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</label>
                            </div>
                        </div>
                        <div class=""p-3"">
                            <div class=""form-check mb-0 py-1"">
            ...
            WriteLiteral(@" consectetur adipisicing elit.</label>
                            </div>
                        </div>
                    </div>
                </div>
...
<section>
                ...
                <div class=""card mb-0"">
                    <div class=""card-header position-relative px-4"">
                        <div class=""card-close"">
                            <div class=""dropdown"">
                                <button class=""dropdown-toggle text-sm"" type=""button"" id=""closeCard1"" data-bs-toggle=""dropdown"" aria-expanded=""false""><i class=""fas fa-ellipsis-v""></i></button>
                                <div class=""dropdown-menu dropdown-menu-end shadow-sm"" aria-labelledby=""closeCard1""><a class=""dropdown-item py-1 px-3 remove"" href=""#""> <i cla");
            WriteLiteral(@"ss=""fas fa-times""></i>Close</a><a class=""dropdown-item py-1 px-3 edit"" href=""#""> <i class=""fas fa-cog""></i>Edit</a></div>
                            </div>
                        </div>
                    ...
                    <div class=""card-body p-0"">
                        ...
                        <div class=""p-3 d-flex justify-content-between"">
                            <div class=""d-flex"">
                                <i class=""fas fa-rss text-gray-600""></i>
                                <div class=""ms-3"">
                            ...
                            <div class=""text-end ms-2""><strong class=""d-blo");
            WriteLiteral(@"ck lh-1 h2 mb-0 text-gray-500"">24</strong><small class=""d-block lh-1 text-gray-500"">May</small></div>
                        </div>
                        <!-- Item-->
                        ...
                        <!-- Item-->
                ");
            WriteLiteral(@"        <div class=""p-3 d-flex justify-content-between"">
                            <div class=""d-flex"">
                                <i class=""fas fa-rss text-gray-600""></i>
                                <div class=""ms-3"">
                                    <h5 class=""fw-normal text-gray-600 mb-1"">Lorem ipsum dolor sit amet.</h5>
                        ...
                        <div class=""p-3 d-flex justify-content-between"">
                            <div class=""d-flex"">
                                ...
                                <div class=""ms-3"">
                                    <h5 class=""fw-normal text-gray-600 mb-1"">Lorem ipsum dolor sit amet.</h5>
                                    <p cla");
            WriteLiteral(@"ss=""mb-0 text-xs text-gray-500"">Lorem ipsum dolor sit amet, consectetur adipisicing elit sed.</p>
                                </div>
                            </div>
                            <div class=""text-end ms-2""><strong class=""d-block lh-1 h2 mb-0 text-gray-500"">24</strong><small class=""d-block lh-1 text-gray-500"">May</small></div>
                        </div>
                ...
                <div class=""card mb-0"">
                    <div class=""card-header position-relative"">
                        <div class=""card-close"">
                            <div class=""dropdown"">
                                <button class=""dropdown-toggle text-sm"" type=""button"" id=""closeCard1"" data-bs-toggle=""dropdown"" aria-expanded=""false""><i class=""fas fa-ellipsis-v""></i></button>
                                <div class=""dropdown-menu dropdown-menu-end shadow-sm"" aria-lab");
            WriteLiteral(@"elledby=""closeCard1""><a class=""dropdown-item py-1 px-3 remove"" href=""#""> <i class=""fas fa-times""></i>Close</a><a class=""dropdown-item py-1 px-3 edit"" href=""#""> <i class=""fas fa-cog""></i>Edit</a></div>
                            </div>
                        </div>
                    ...
                    <div class=""card-body p-0"">
                        ...
                        <div class=""p-3 border-bottom border-gray-200"">
                            <div class=""d-flex justify-content-between"">
                                <div class=""d-flex"">
                                    <a class=""flex-shrink-0"" href=""#""><img class=""img-fluid rounded-circle"" src=""assets/img/avatar-5.jpg"" alt=""person"" width=""50""></a>
                                    <div class=""ms-3"">
                                        <h5>Aria Smith</h5>
                                        <p class=""mb-0 text-xs text-gray-600 lh-1"">Posted a");
            WriteLiteral(@" new blog</p><small class=""text-gray-600 fw-light"">Today 5:60 pm - 12.06.2014</small>
                                    </div>
                                </div>
                        ...
                        <div class=""p-3 border-bottom border-gray-200"">
                            <div class=""d-flex justify-content-between"">
                                <div class=""d-flex"">
                                    <a class=""flex-shrink-0"" href=""#""><img class=""img-fluid rounded-circle"" src=""assets/img/avatar-2.jpg"" alt=""person"" width=""50""></a>
                                    <div class=""ms-3"">
                                        <h5>Frank Williams</h5>
                                        <p class=""mb-0 text-xs text-gray-600 lh-1"">Posted a new blog</p><small class=""text-gray-600 fw-light"">Today ");
            WriteLiteral(@"5:60 pm - 12.06.2014</small>
                        ...
                        <div class=""p-3"">
                            <div class=""d-flex justify-content-between"">
                                <div class=""d-flex"">
                                    <a class=""flex-shrink-0"" href=""#""><img class=""img-fluid rounded-circle"" src=""assets/img/avatar-3.jpg"" alt=""person"" width=""50""></a>
                                    <div class=""ms-3"">
                                   ");
            WriteLiteral(@"     <h5>Ashley Wood</h5>
            ...
            WriteLiteral(@"rd-body p-0"">
                        <div class=""row g-0 border-bottom border-gray-200"">
                            ...
                            <div class=""col-sm-8 col-9 border-start border-gray-200 p-3"">
                                ...
                                <p class=""small mb-0 text-gray-600"">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed d");
            WriteLiteral(@"o eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</p>
                            </div>
                        </div>
                        <div class=""row g-0 border-bottom border-gray-200"">
                            <div class=""col-sm-4 col-3 text-end"">
                            ...
                            <div class=""col-sm-8 col-9 border-start border-gray-200 p-3"">
                                <h5 clas");
            WriteLiteral(@"s=""fw-normal"">Meeting</h5>
  ...
  ");
            WriteLiteral(@"                          <div class=""col-sm-8 col-9 border-start border-gray-200 p-3"">
                                <h5 class=""fw-normal"">Meeting</h5>
                                <p class=""small mb-0 text-gray-600"">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</p>
                            </div>
                        </div>
    ...
    <div class=""container-fluid"">
        <div class=""row gy-2"">
            ...
            <div class=""col-sm-6 text-sm-end"">
                <p class=""mb-0"">Design by <a href=""https://bootstr");
            WriteLiteral(@"apious.com/p/admin-template"" class=""text-white text-decoration-none"">Bootstrapious</a></p>
